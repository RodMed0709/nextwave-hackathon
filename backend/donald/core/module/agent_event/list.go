...
func (m *module) List(ctx context.Context,
	...
	// cache hit to do it.
	cacheKey := list.CacheKey("ListAgentEvent", query, args)
	if !skipShared {
	...
	runList := func() (any, error) {
		...
		if err != nil {
			...
			m.logger.Error("error in executing query for ListAgentEvent", zap.String("query", query), zap.Int("args", len(args)), zap.Error(err))
			return types.ListResponse{}, err
		}
		defer rows.Close()
		var scanGetters []func(*repogen.AgentEvent) any
		...
		var items []repogen.AgentEvent
		for rows.Next() {
			var i repogen.AgentEvent
		...
		return types.ListResponse{
			AgentEvent:  mapModelsToEntities(items),
...
var listFieldRegistry = map[string]func(*repogen.AgentEvent) any{

	"uuid": func(i *repogen.AgentEvent) any { return &i.UUID },

	"run_uuid": func(i *repogen.AgentEvent) any { return &i.RunUUID },

	"sequence": func(i *repogen.AgentEvent) any { return &i.Sequence },

	"event_type": func(i *repogen.AgentEvent) any { return &i.EventType },

	"node_uuid": func(i *repogen.AgentEvent) any { return &i.NodeUUID },

	"agent_label": func(i *repogen.AgentEvent) any { return &i.AgentLabel },

	"idempotency_key": func(i *repogen.AgentEvent) any { return &i.IdempotencyKey },

	"occurred_at": func(i *repogen.AgentEvent) any { return &i.OccurredAt },

	"status": func(i *repogen.AgentEvent) any { return &i.Status },

	"created_by": func(i *repogen.AgentEvent) any { return &i.CreatedBy },

	"updated_by": func(i *repogen.AgentEvent) any { return &i.UpdatedBy },

	"created_at": func(i *repogen.AgentEvent) any { return &i.CreatedAt },

	"updated_at": func(i *repogen.AgentEvent) any { return &i.UpdatedAt },

	"payload": func(i *repogen.AgentEvent) any { return &i.Payload },
}
