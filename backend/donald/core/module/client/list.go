...
func (m *module) List(ctx context.Context,
	...
	// cache hit to do it.
	cacheKey := list.CacheKey("ListClient", query, args)
	if !skipShared {
	...
	runList := func() (any, error) {
		...
		if err != nil {
			...
			m.logger.Error("error in executing query for ListClient", zap.String("query", query), zap.Int("args", len(args)), zap.Error(err))
			return types.ListResponse{}, err
		}
		defer rows.Close()
...
var listFieldRegistry = map[string]func(*repogen.Client) any{
	...
	"uuid": func(i *repogen.Client) any { return &i.UUID },

	"name": func(i *repogen.Client) any { return &i.Name },

	"industry": func(i *repogen.Client) any { return &i.Industry },

	"created_by": func(i *repogen.Client) any { return &i.CreatedBy },

	"updated_by": func(i *repogen.Client) any { return &i.UpdatedBy },

	"status": func(i *repogen.Client) any { return &i.Status },
