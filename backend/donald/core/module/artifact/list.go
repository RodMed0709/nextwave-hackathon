...
func (m *module) List(ctx context.Context,
	...
	// cache hit to do it.
	cacheKey := list.CacheKey("ListArtifact", query, args)
	if !skipShared {
	...
	runList := func() (any, error) {
		...
		if err != nil {
			...
			m.logger.Error("error in executing query for ListArtifact", zap.String("query", query), zap.Int("args", len(args)), zap.Error(err))
			return types.ListResponse{}, err
		}
		defer rows.Close()
		var scanGetters []func(*repogen.Artifact) any
		...
		var items []repogen.Artifact
		for rows.Next() {
			var i repogen.Artifact
		...
		return types.ListResponse{
			Artifact:    mapModelsToEntities(items),
...
var listFieldRegistry = map[string]func(*repogen.Artifact) any{

	"uuid": func(i *repogen.Artifact) any { return &i.UUID },

	"run_uuid": func(i *repogen.Artifact) any { return &i.RunUUID },

	"node_uuid": func(i *repogen.Artifact) any { return &i.NodeUUID },

	"name": func(i *repogen.Artifact) any { return &i.Name },

	"artifact_type": func(i *repogen.Artifact) any { return &i.ArtifactType },

	"content": func(i *repogen.Artifact) any { return &i.Content },

	"url": func(i *repogen.Artifact) any { return &i.URL },

	"content_type": func(i *repogen.Artifact) any { return &i.ContentType },

	"size_bytes": func(i *repogen.Artifact) any { return &i.SizeBytes },

	"text_content": func(i *repogen.Artifact) any { return &i.TextContent },

	"status": func(i *repogen.Artifact) any { return &i.Status },

	"created_by": func(i *repogen.Artifact) any { return &i.CreatedBy },

	"updated_by": func(i *repogen.Artifact) any { return &i.UpdatedBy },

	"created_at": func(i *repogen.Artifact) any { return &i.CreatedAt },

	"updated_at": func(i *repogen.Artifact) any { return &i.UpdatedAt },
}
