...
func (m *module) List(ctx context.Context,
	...
	// cache hit to do it.
	cacheKey := list.CacheKey("ListAgentEdge", query, args)
	if !skipShared {
	...
	runList := func() (any, error) {
		...
		if err != nil {
			...
			m.logger.Error("error in executing query for ListAgentEdge", zap.String("query", query), zap.Int("args", len(args)), zap.Error(err))
			return types.ListResponse{}, err
		}
		defer rows.Close()
		var scanGetters []func(*repogen.AgentEdge) any
		...
		var items []repogen.AgentEdge
		for rows.Next() {
			var i repogen.AgentEdge
		...
		return types.ListResponse{
			AgentEdge:   mapModelsToEntities(items),
...
var listFieldRegistry = map[string]func(*repogen.AgentEdge) any{

	"uuid": func(i *repogen.AgentEdge) any { return &i.UUID },

	"run_uuid": func(i *repogen.AgentEdge) any { return &i.RunUUID },

	"from_node_uuid": func(i *repogen.AgentEdge) any { return &i.FromNodeUUID },

	"to_node_uuid": func(i *repogen.AgentEdge) any { return &i.ToNodeUUID },

	"edge_type": func(i *repogen.AgentEdge) any { return &i.EdgeType },

	"condition_label": func(i *repogen.AgentEdge) any { return &i.ConditionLabel },

	"status": func(i *repogen.AgentEdge) any { return &i.Status },

	"created_by": func(i *repogen.AgentEdge) any { return &i.CreatedBy },

	"updated_by": func(i *repogen.AgentEdge) any { return &i.UpdatedBy },

	"created_at": func(i *repogen.AgentEdge) any { return &i.CreatedAt },

	"updated_at": func(i *repogen.AgentEdge) any { return &i.UpdatedAt },
}
