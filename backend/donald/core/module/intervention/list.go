...
func (m *module) List(ctx context.Context,
	...
	// cache hit to do it.
	cacheKey := list.CacheKey("ListIntervention", query, args)
	if !skipShared {
	...
	runList := func() (any, error) {
		...
		if err != nil {
			...
			m.logger.Error("error in executing query for ListIntervention", zap.String("query", query), zap.Int("args", len(args)), zap.Error(err))
			return types.ListResponse{}, err
		}
		defer rows.Close()
		var scanGetters []func(*repogen.Intervention) any
		...
		var items []repogen.Intervention
		for rows.Next() {
			var i repogen.Intervention
		...
		return types.ListResponse{
			Intervention: mapModelsToEntities(items),
...
var listFieldRegistry = map[string]func(*repogen.Intervention) any{

	"uuid": func(i *repogen.Intervention) any { return &i.UUID },

	"run_uuid": func(i *repogen.Intervention) any { return &i.RunUUID },

	"node_uuid": func(i *repogen.Intervention) any { return &i.NodeUUID },

	"type": func(i *repogen.Intervention) any { return &i.Type },

	"prompt": func(i *repogen.Intervention) any { return &i.Prompt },

	"status": func(i *repogen.Intervention) any { return &i.Status },

	"status_message": func(i *repogen.Intervention) any { return &i.StatusMessage },

	"requested_by_uuid": func(i *repogen.Intervention) any { return &i.RequestedByUUID },

	"resolved_by_uuid": func(i *repogen.Intervention) any { return &i.ResolvedByUUID },

	"delivered_at": func(i *repogen.Intervention) any { return &i.DeliveredAt },

	"resolved_at": func(i *repogen.Intervention) any { return &i.ResolvedAt },

	"expires_at": func(i *repogen.Intervention) any { return &i.ExpiresAt },

	"created_by": func(i *repogen.Intervention) any { return &i.CreatedBy },

	"updated_by": func(i *repogen.Intervention) any { return &i.UpdatedBy },

	"created_at": func(i *repogen.Intervention) any { return &i.CreatedAt },

	"updated_at": func(i *repogen.Intervention) any { return &i.UpdatedAt },

	"interactions": func(i *repogen.Intervention) any { return &i.Interactions },
}
