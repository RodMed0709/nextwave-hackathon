...
func (m *module) List(ctx context.Context,
	...
	// cache hit to do it.
	cacheKey := list.CacheKey("ListAgentRun", query, args)
	if !skipShared {
	...
	runList := func() (any, error) {
		...
		if err != nil {
			...
			m.logger.Error("error in executing query for ListAgentRun", zap.String("query", query), zap.Int("args", len(args)), zap.Error(err))
			return types.ListResponse{}, err
		}
		defer rows.Close()
		var scanGetters []func(*repogen.AgentRun) any
		...
		var items []repogen.AgentRun
		for rows.Next() {
			var i repogen.AgentRun
		...
		return types.ListResponse{
			AgentRun:    mapModelsToEntities(items),
...
var listFieldRegistry = map[string]func(*repogen.AgentRun) any{

	"uuid": func(i *repogen.AgentRun) any { return &i.UUID },

	"client_uuid": func(i *repogen.AgentRun) any { return &i.ClientUUID },

	"run_key": func(i *repogen.AgentRun) any { return &i.RunKey },

	"name": func(i *repogen.AgentRun) any { return &i.Name },

	"display_summary": func(i *repogen.AgentRun) any { return &i.DisplaySummary },

	"agent_summary": func(i *repogen.AgentRun) any { return &i.AgentSummary },

	"agent_identifier": func(i *repogen.AgentRun) any { return &i.AgentIdentifier },

	"initial_prompt": func(i *repogen.AgentRun) any { return &i.InitialPrompt },

	"protocol_version": func(i *repogen.AgentRun) any { return &i.ProtocolVersion },

	"status": func(i *repogen.AgentRun) any { return &i.Status },

	"status_message": func(i *repogen.AgentRun) any { return &i.StatusMessage },

	"graph_revision": func(i *repogen.AgentRun) any { return &i.GraphRevision },

	"last_event_sequence": func(i *repogen.AgentRun) any { return &i.LastEventSequence },

	"started_at": func(i *repogen.AgentRun) any { return &i.StartedAt },

	"finished_at": func(i *repogen.AgentRun) any { return &i.FinishedAt },

	"last_heartbeat_at": func(i *repogen.AgentRun) any { return &i.LastHeartbeatAt },

	"created_by": func(i *repogen.AgentRun) any { return &i.CreatedBy },

	"updated_by": func(i *repogen.AgentRun) any { return &i.UpdatedBy },

	"created_at": func(i *repogen.AgentRun) any { return &i.CreatedAt },

	"updated_at": func(i *repogen.AgentRun) any { return &i.UpdatedAt },
}
